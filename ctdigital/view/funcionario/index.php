...
<div id="infoView" hidden=""> 
    ...
    <div id="_tituloMenuPrincipal">Trabalhadores</div>
                ...
                <tbody>
                    <?php if (isset($_pagina['model'])) : ?>
                        <?php foreach ($_pagina['model'] as $item): ?>
                            <tr>
                                <td><a href="../../funcionario/detalhes/?id=<?php echo $item->getCpf(); ?>"><?php echo $item->getNome(); ?></a></td>
                                <td><?php echo StringHelper::getSexo($item->getSexo()); ?></td>
                                <td><?php echo StringHelper::getCpf($item->getCpf()); ?></td>
                                <td><?php echo StringHelper::dataEN2BR($item->getDataNascimento()); ?></td>
                            </tr>
                        <?php endforeach; ?>
                        <?php
