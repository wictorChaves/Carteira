...
<div id="infoView" hidden=""> 
    <div id="_tituloHead">Lista das Admin Empresas</div>
    <div id="_tituloMenuPrincipal">Admin Empresas</div>
                ...
                <tbody>
                    <?php if (isset($_pagina['model'])) : ?>
                        <?php foreach ($_pagina['model'] as $item): ?>
                            <tr>
                                <td><a href="../../rootempresa/detalhes/?id=<?php echo $item->getCnpj(); ?>"><?php echo $item->getNomeFantasia(); ?></a></td>
